...
lambda <- lambda_1 + lambda_2 + lambda_3
c <- c_1 + c_2 + c_3
alphas <- c(alpha_1, alpha_2, alpha_3)
probs <- c(lambda_1, lambda_2, lambda_3)/lambda
...
clusterExport(cl, varlist = c("rmixtureofexponentials", "SimulateRuinProbabilityIndividual", "SimulateRuinProbabilityPool", "T_max", "Simulations", "lambda_1", "alpha_1", "c_1", "lambda_2", "alpha_2", "c_2", "lambda_3", "alpha_3", "c_3", "lambda", "c", "alphas", "probs", "MP_1s", "MP_2s", "MP_3s", "ALT_1s", "ALT_2s", "ALT_3s", "betasMP_1", "betasMP_2", "betasMP_3", "betasALT_1", "betasALT_2", "betasALT_3"))

ruin_probs_pooled_fund <- parSapply(cl, initial_capitals, function(IC) {SimulateRuinProbabilityPool(InitialCapital = IC, c = c, lambda = lambda, probs = probs, alphas = alphas, T_max = T_max, Simulations = Simulations)})
...
tikz('PlotInfiniteTimeRuinProbabilityAppendixDSupplementaryExampleAssumption34 (Monte Carlo) - All Participants ALT.tex', standAlone = TRUE, width = 4, height = 4, packages = c("\\usepackage{tikz}", "\\usepackage[active,tightpage,psfixbb]{preview}", "\\PreviewEnvironment{pgfpicture}", "\\setlength\\PreviewBorder{0pt}", "\\usepackage{amssymb}", "\\usepackage{scalerel}", "\\usepackage{amsmath}"))
my.expressions <- c("$\\psi_{{\\scaleto{1}{3pt}}}^{{\\scaleto{ {\\fontfamily{qcr}\\selectfont \\text{POOL}}}{3pt}}}\\left(\\kappa\\right)$", "$\\psi_{{\\scaleto{2}{3pt}}}^{{\\scaleto{ {\\fontfamily{qcr}\\selectfont \\text{POOL}}}{3pt}}}\\left(\\kappa\\right)$", "$\\psi_{{\\scaleto{3}{3pt}}}^{{\\scaleto{ {\\fontfamily{qcr}\\selectfont \\text{POOL}}}{3pt}}}\\left(\\kappa\\right)$", "$\\psi_{{\\scaleto{1}{3pt}}}\\left(\\kappa\\right)$", "$\\psi_{{\\scaleto{2}{3pt}}}\\left(\\kappa\\right)$", "$\\psi_{{\\scaleto{3}{3pt}}}\\left(\\kappa\\right)$", "$\\psi\\left(\\kappa\\right)$")
par(mgp = c(2.5, 1, 0), mar = c(3.5, 3.5, 1, 1) + 0.1)
